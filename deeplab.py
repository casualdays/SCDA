...
class DeeplabV3(object):
    _defaults = {
        ...
        #   "Loading the model here."
        #-------------------------------------------------------------------#
        "model_path"        : 'model_data/ep090-loss1.074-val_loss1.188.pth',
        #----------------------------------------#
    ...
    def __init__(self, **kwargs):
        ...
        if self.num_classes <= 6:
            self.colors = self.colors = [ (255, 0, 0), (255, 255, 255),(0, 0, 255),(255, 255, 0),(0, 255, 0),(0, 255, 255)]
        else:
    ...
    def generate(self, onnx=False):
        ...
        self.net = DeepR50V3PlusD(num_classes=self.num_classes)
